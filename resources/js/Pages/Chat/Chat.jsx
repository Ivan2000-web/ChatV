                        ...
                        <div className="basis-2/6 border-r border-slate-100 bg-white pt-3">
                            ...
                            <div class="user-list h-screen overflow-y-auto">
                                <div class="flex px-5 py-3 transition hover:cursor-pointer hover:bg-slate-100">
                                    ...
                                    <div>
                                        <h3 class="text-md text-violet-500">Ivan Ivanov</h3>
                                ...
                                <div class="flex px-5 py-3 transition hover:cursor-pointer hover:bg-slate-100">
                                    ...
                                    <div>
                                        <h3 className="text-md text-violet-500">Ivan Ivanov</h3>
                            ...
                            <div className="user-info-header bg-white px-5 py-3">
                                <div className="flex justify-between">
                                    <div className="flex items-center">
                                        <img src="https://cdn-icons-png.flaticon.com/512/194/194935.png" width="40" />
                                        <h3 className="text-md pl-4 text-gray-400">Ivan Ivanov</h3>
                                    </div>
                                    <div>
